...
type Event struct {
	...
	RicorrenzaGiorno int            `gorm:"default:-1" json:"ricorrenza_giorno"`
...
type Offer struct {
	...
	OraValidaDal     string         `gorm:"size:5" json:"ora_valida_dal"`
	OraValidaFino    string         `gorm:"size:5" json:"ora_valida_fino"`
	RicorrenzaGiorno int            `gorm:"default:-1" json:"ricorrenza_giorno"`
...
type Reward struct {
	...
	Titolo         string         `gorm:"size:200;not null" json:"titolo"`
	Descrizione    string         `gorm:"type:text;not null" json:"descrizione"`
	PuntiRichiesti int            `gorm:"not null" json:"punti_richiesti"`
	ImmagineURL    string         `gorm:"type:text" json:"immagine_url"`
	CreatedAt      time.Time      `json:"created_at"`
	UpdatedAt      time.Time      `json:"updated_at"`
	DeletedAt      gorm.DeletedAt `gorm:"index" json:"-"`
