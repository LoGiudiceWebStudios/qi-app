...
class ForgetPasswordVerificationScreen extends StatefulWidget {
  final String email;
  const ForgetPasswordVerificationScreen({super.key, required this.email});

  @override
  State<ForgetPasswordVerificationScreen> createState() =>
                      ...
                      onTap: () {
                        ...
                        if (otpCodde == "") {
                          ToastUtil.showShortToast(
                              "Please insert OTP code first");
                        } else {
                          _isLoading.value = true;
                          forgetPasswordVerifyOtpApiRx
                              .verofyOtp(email: widget.email, otp: otpCodde)
                              .then((sucess) {
                            if (sucess) {
                              _isLoading.value = false;
                              NavigationService.navigateToReplaceWithArgs(
                                  Routes.setNewPassword,
                                  {'email': widget.email, 'otp': otpCodde});
                            }
                            _isLoading.value = false;
                          });
                        }
